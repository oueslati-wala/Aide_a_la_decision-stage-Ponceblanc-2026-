...
Application Streamlit d'aide à la décision pour le pricing des devis.

Le commercial saisit **client**, **produit**, **quantité** et **coût total (€)**.  
...
```bash
cd 3   # ou le dossier contenant vis.py
